document.getElementById('floating-theme').addEventListener('click',()=>changeTheme());
...
function changeTheme(){
    ...
    if(lightTheme){
        ...
        document.querySelectorAll('p').forEach(p=>p.style.color='rgb(255,255,255)');
    }else{
        lightTheme=true;
        ...
        document.querySelectorAll('p').forEach(p=>p.style.color='rgb(0,0,0)');
    }
}